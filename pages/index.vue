    ...
    <v-main class="justify-center align-center">
      <v-form>
        <svg class="logo" width="48" height="36" viewBox="0 0 48 36" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M19.0035 11.7837L15.2315 7.95898C12.6876 10.5273 11.1111 14.0804 11.1111 18.0006C11.1111 21.9212 12.6907 25.466 15.2315 28.0462L19.0035 24.2163C18.0471 23.2446 17.3095 22.0453 16.8793 20.7084H31.122C30.6918 22.0453 29.9542 23.2446 28.9947 24.2163L32.7698 28.0462C35.3156 25.466 36.8867 21.9212 36.8867 18.0006C36.8867 14.0804 35.3156 10.5273 32.7698 7.95898L28.9947 11.7837C29.9542 12.755 30.6918 13.9567 31.122 15.2931H16.8793C17.3095 13.9567 18.0471 12.755 19.0035 11.7837Z" fill="#101828"/>
          <path d="M36.8477 3.82626C40.4372 7.45826 42.6538 12.4719 42.6538 18.0006C42.6538 23.5293 40.4372 28.5449 36.8477 32.167L40.622 36C45.1813 31.386 48 25.0204 48 18.0006C48 10.9796 45.1813 4.61522 40.622 0L36.8477 3.82626ZM11.1492 3.82626L7.37447 0C2.82185 4.61522 0 10.9796 0 18.0006C0 25.0204 2.82185 31.386 7.37447 36L11.1559 32.1737C7.5663 28.5449 5.34617 23.5293 5.34617 18.0006C5.34617 12.4735 7.5663 7.45826 11.1492 3.82626Z" fill="#101828"/>
        </svg>
        <h1>Log in to your account</h1>
        <div class="input-item">
          <span>Email</span>
          <input type="email" placeholder="name@hoteldomain.com" required minlength="5" autofocus>
